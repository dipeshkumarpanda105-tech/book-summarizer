...
declare module 'src/display/Label' {
	...
	export class Label extends DisplayObject {
	    ...
	    get linearGradientType(): 'vertical' | 'horizontal';
	    set linearGradientType(value: 'vertical' | 'horizontal');
	    get linearGradientStops(): number[];
	    set linearGradientStops(value: number[]);
...
declare module 'src/layout/CSSStyle' {
	...
	export class CSSStyle {
	    ...
	    */
	    ...
	    set backgroundColor(value: number | undefined);
	    /**
	     * 设置元素的背景圆角
	     */
	    ...
	    * */
	    ...
	    /** 描边颜色 */
	    private _stroke?;
	    get stroke(): string | number | undefined;
	    set stroke(value: string | number | undefined);
	    /** 描边的笔触粗细值 */
	    ...
	    get dropShadowColor(): number;
	    set dropShadowColor(value: number);
	    /** 投影深度 */
...
declare module 'src/utils/systemInfo' {
	/**
	 * 获取设备信息
	 */
	export function systemInfo(callFunc: (info: any, key: string, step: number, total: number) => {}): any;
...
declare module 'src/utils/Utils' {
	...
	export * from 'src/utils/systemInfo';
...
declare module 'src/display/Slider' {
	...
	export class Slider extends DisplayObject {
	    ...
	    get track(): string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | undefined;
	    set track(value: string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | undefined);
	    /**
	     * 手柄
	     */
	    protected _thumb?: string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement;
	    get thumb(): string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | undefined;
	    set thumb(value: string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | undefined);
	    /**
	     * 进度
	     */
	    protected _tracklight?: string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement;
	    get tracklight(): string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | undefined;
	    set tracklight(value: string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | undefined);
...
declare module 'src/display/FollowLine' {
	...
	export class FollowLine extends DisplayObject {
	    ...
	    set isErasing(value: boolean);
	    /** 角色状态 */
	    private _role;
	    get role(): FollowLineEnum.Role;
	    set role(value: FollowLineEnum.Role);
	    /**
	     * @private
	     * 提交属性，子类在调用完invalidateProperties()方法后，应覆盖此方法以应用属性
	     */
...
declare module 'src/display/Tracing' {
	...
	export class Tracing extends DisplayObject {
	    ...
	    get traceSprite(): string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | undefined;
	    set traceSprite(value: string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | undefined);
	    /**
	     * 背景图，mask模式用于画线后漏出来
	     */
	    private _renderBgSprite;
	    get renderBgSprite(): string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | undefined;
	    set renderBgSprite(value: string | number | vf.Texture | HTMLImageElement | HTMLCanvasElement | HTMLVideoElement | undefined);
	    /**
	     * 轨迹点,二维数组
	     */
